        ...
        <?php foreach ($posts as $key => $value): ?>
            <article class="popular__post post <?=$value['type']; ?>">
                ...
                <?php if ($value['type'] == 'post-text') {
                        cut_text ($value['content']);   // добавляем функцию ограничивающую длину текста
                        }
                ?>
                </div>
